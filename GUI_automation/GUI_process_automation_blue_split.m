...
try
    ...
    app.emissionwavelengthmEditField.Value = 0.525;
...
try
    app.zStackFile = 'D:\projekt\aberrations_measurement\data\beads_red_blue_split_dual\avg_pos2_red_blue_split_Bead4.tif';
