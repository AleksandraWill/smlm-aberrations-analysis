...
path_input_data = 'D:\projekt\aberrations_measurement\data\beads_red_blue_split_red_dual\avg_pos2_red_blue_split.tif';
% Set the output folder (can be the same as the input folder):
path_output_data = 'D:\projekt\aberrations_measurement\data\beads_red_blue_split_red_dual\';
