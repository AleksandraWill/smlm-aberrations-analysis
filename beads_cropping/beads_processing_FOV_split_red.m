...
path_input_data = 'D:\projekt\aberrations_measurement\data\beads_red_split\avg_pos3_red_split.tif';
% Set the output folder (can be the same as the input folder):
path_output_data = 'D:\projekt\aberrations_measurement\data\beads_red_split\';
