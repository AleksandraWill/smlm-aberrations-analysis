...
path_input_data = 'D:\projekt\aberrations_measurement\data\beads_blue_split\avg_pos3_blue_split.tif';
% Set the output folder (can be the same as the input folder):
path_output_data = 'D:\projekt\aberrations_measurement\data\beads_blue_split\';
